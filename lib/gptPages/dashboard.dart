        ...
        child: Column(
          children: [
            ...
            const Text.rich(
              TextSpan(
                children: [
                  TextSpan(text: '65', style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold)),
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: const Text("detail", style: TextStyle(color: Colors.teal)),
              ),
            ),
                ...
                child: Row(
                  ...
                  children: weekData.map((dayData) {
                    return Column(
                      ...
                      children: [
                        Text("${dayData['value']}", style: const TextStyle(fontWeight: FontWeight.bold)),
                        Container(
